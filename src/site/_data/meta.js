...
module.exports = async (data) => {
  ...
  const uiStrings = {
    backlinkHeader: process.env.UI_BACKLINK_HEADER || "References",
    noBacklinksMessage: process.env.UI_NO_BACKLINKS_MESSAGE || "No references yet",
    searchButtonText: process.env.UI_SEARCH_BUTTON_TEXT || "Search docs",
    searchPlaceholder: process.env.UI_SEARCH_PLACEHOLDER || "Search documentation...",
    searchNotStarted: process.env.UI_SEARCH_NOT_STARTED_TEXT || "Type to search notes, projects, and ideas",
  ...
  const meta = {
    ...
    siteName: process.env.SITE_NAME_HEADER || "Eriri",
