...
// Cloudflare Pages / static hosting: set STATIC_EXPORT=1 (see scripts/build-static.mjs).
...
const output = withBundleAnalyzer({
  ...
  trailingSlash: true,
  images: {
    // Static export cannot use the Next Image Optimization API.
    unoptimized: isStaticExport || process.env.NEXT_IMAGE_UNOPTIMIZED === '1',
