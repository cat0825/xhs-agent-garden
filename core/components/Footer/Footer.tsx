      ...
      >
          ...
          >
            ...
            >
              ...
              <Grid.Item col={1}>
                ...
                <Anchor discreet href="https://github.com/cat0825" external>
                  <ScrambledText
                    disabled={!isInView}
                    delay={0.5}
                    speed={0.8}
              ...
              <Grid.Item col={2}>
                ...
                <Anchor discreet external href="https://github.com/cat0825">
                  <ScrambledText
                    disabled={!isInView}
                    delay={0.5}
                    speed={0.8}
              ...
              <Grid.Item>
                <Text size={1}>
                  <Grid>
                    ...
                    <Anchor as={Link} discreet href="/concepts/halftone/">
                      {t.concepts}
                    </Anchor>
                  </Grid>
                </Text>
              ...
              <Grid.Item>
                <Text size={1}>
                  <Grid>
                    ...
                    <Anchor as={Link} discreet href="/rss.xml">
                      RSS
                    </Anchor>
                  </Grid>
                </Text>
        ...
        >
          <Flex
            ...
            col={2}
          >
            <Logo alt="Craft Garden · 千羽鹤 logo" size={40} />
            <Box>
              <Text
                as="p"
                css={{
                ...
                weight="3"
              >
                © {new Date().getFullYear()} 千羽鹤 · Craft Garden{' '}
                <EM size="1">Beijing, China</EM>
              </Text>
            </Box>
          </Flex>
        </Grid>
